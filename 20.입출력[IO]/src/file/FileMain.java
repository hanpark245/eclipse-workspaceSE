...
public class FileMain {
	...
	public static void main(String[] args) 
	{
		...
		File dir2 = new File("sampel/subSample");
		...
		System.out.println("11.Directroy 이름변경");
		boolean isRename = newDir2.renameTo(new File("renmaeDir2"));
		System.out.println(">>이름변경여부: " + isRename);
		System.out.println("Directory 삭제");
		...
		try {
			...
			System.out.println(">>파일 생성여부" + isCreate);
		} catch (IOException e) {
